...
<thead>
    <tr>
        ...
        <c:when test="${field == 'privateNote'}"><th class="bigcol ${collapsed}"><t:optionbutton optionname="collapse-${field}" title="ex" style="content" classes="expandbutton" norefresh="true"></t:optionbutton>Notas priv</th></c:when>
