        ...
        <div class="heading2">
            ...
            <div id="occurrencefilter">
                <form method="get" action="occurrences" class="inlineblock">
                    ...
                    <t:helpbutton msgid="filterhelp">
                        <h1>Como usar os filtros avançados</h1>
                        <p>Pode fazer filtros compostos por vários campos, os quais devolvem os registos que simultaneamente cumprem todas as condições. A estes, pode ser adicionado um filtro textual, que procurará em vários campos de texto simultaneamente.</p>
                        ...
                        <code>lat:</code> latitude<br/><code>long:</code> longitude<br/><code>tax:</code> taxon
                        </p>
