...
<head>
	...
	<link rel="stylesheet" type="text/css" href="redlist.css"/>
    ...
    <c:if test="${sessionScope.user == null}">
        ...
        <c:when test="${what=='main'}">
            ...
            <c:forEach var="taxon" items="${specieslist.iterator()}">
                ...
                <c:if test="${!taxon.isSpecies()}">
                    ...
                    <td><a href="?w=taxon&id=${taxon.getIDURLEncoded()}">${taxon.getFullName(true)}</a></td>
                </tr>
            </c:forEach>
            </table>
        </c:when>
        ...
        <c:when test="${what=='taxon'}">
            ...
            <table class="sheet">
                ...
                <tr class="section1 textual"><td class="number">1.1</td><td colspan="2"><h1><i>${taxon.getName()}</i></h1><p style="text-align:center"><a href="?w=taxonrecords&id=${taxon.getIDURLEncoded()}">view occurrences</a></p></td></tr>
                ...
                <tr class="section1"><td class="number">1.4</td><td>Taxonomic problems</td><td>
                    <table>
                        ...
                        <input type="checkbox" name="taxonomicProblems">
                        </td></tr>
                        <tr><td>Problem description</td><td><input type="text" name="taxonomicProblemDesc"/></td></tr>
                    </table>
                </td></tr>
                ...
                <tr class="section2 textual"><td class="number">2.1</td><td>Distribution (textual)</td><td>
                    <textarea name="verbatimDistribution">aaa</textarea>
                </td></tr>
                ...
                <tr class="section3 textual"><td class="number">3.1</td><td>Population information (textual)</td><td>
                    <textarea name="verbatimPopStatus"></textarea>
                </td></tr>
                <tr class="section3"><td class="number">3.2</td><td>Nº of mature individuals</td><td>
                    <table>
                        <tr><td>Category</td><td>
                            <select name="numberOfIndCategory">
                                <option>No data</option>
                                <option>&gt; 10000</option>
                                <option>2500 - 10000</option>
                                <option>250 - 2500</option>
                                <option>&lt; 250</option>
                                <option>Exact number</option>
                            </select>
                        </td></tr>
                        <tr><td>Exact number</td><td><input type="text" name="numberOfInd"/></td></tr>
                        <tr><td>Textual description</td><td><input type="text" name="numberOfIndVerbatim"/></td></tr>
                    </table>
                </td></tr>
                <tr class="section3"><td class="number">3.3</td><td>Type of estimate</td><td>
                    <select name="typeOfEstimate">
                        <option>Exact count</option>
                        <option>Approximate count</option>
                        <option>Rough estimate</option>
                    </select>
                </td></tr>
                <tr class="section3"><td class="number">3.4</td><td>Population decline</td><td>
                    <select name="populationDecline">
                        <option>No information</option>
                        <option>Stable or no decline</option>
                    </select>
                </td></tr>
                <tr class="section3"><td class="number">3.5</td><td>Population trend</td><td>
                    <input type="text" name="populationTrend"/>
                </td></tr>
                <tr class="section3"><td class="number">3.6</td><td>Severely fragmented</td><td>
                    <select name="severelyFragmented">
                        <option>No information</option>
                        <option>Not severely fragmented</option>
                        <option>Severely fragmented</option>
                    </select>
                </td></tr>
                <tr class="section3"><td class="number">3.7</td><td>Extreme fluctuations</td><td>
                    <select name="extremeFluctuations">
