 ...
 * All Rights Reserved.
 */
package pt.floraon.geometry.mgrs;
...
public class MGRSCoordConverter
{
    ...
    public class MGRSComponents
    {
        ...
        public final int latitudeBand;
        public final int squareLetter1;
        public final int squareLetter2;
        public final double easting;
        public final double northing;
        public final int precision;

        public char getLatitudeBand() {
            return alphabet.charAt(this.latitudeBand);
        }
    ...
    /**
     * This is a modern version of breakMGRSString
     * @param MGRSString
     * @return
     */
    private MGRSComponents parseMGRSString(String MGRSString, Map<String, String> defaultZones) {
        ...
        northing = Integer.parseInt(coords.substring(coords.length() / 2));
        easting = Integer.parseInt(coords.substring(0, coords.length() / 2));
        multiplier = Math.pow(10.0, 5 - precision);
        easting *= multiplier;
        northing *= multiplier;
