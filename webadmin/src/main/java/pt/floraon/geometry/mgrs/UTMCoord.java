...
public class UTMCoord
{
    ...
    private MGRSCoordConverter.MGRSComponents MGRS;
    ...
    public MGRSCoordConverter.MGRSComponents getMGRS() {
        return this.MGRS;
    }

    public void setMGRS(MGRSCoordConverter.MGRSComponents MGRS) {
        this.MGRS = MGRS;
    }
}
